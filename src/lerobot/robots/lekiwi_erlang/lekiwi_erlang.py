...
from .config_lekiwi_erlang import LeKiwiConfig_Erlang

logger = logging.getLogger(__name__)


class LeKiwi_Erlang(Robot):
    """
    ...
    config_class = LeKiwiConfig_Erlang
    name = "lekiwi"

    def __init__(self, config: LeKiwiConfig_Erlang):
