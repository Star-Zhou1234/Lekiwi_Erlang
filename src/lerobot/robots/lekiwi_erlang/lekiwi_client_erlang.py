...
from .config_lekiwi_erlang import LeKiwiErlangClientConfig


class LeKiwiErlangClient(Robot):
    config_class = LeKiwiErlangClientConfig
    name = "lekiwi_client"

    def __init__(self, config: LeKiwiErlangClientConfig):
        import zmq
